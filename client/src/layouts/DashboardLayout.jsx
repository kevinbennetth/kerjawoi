        ...
        <div className="lg:grid lg:grid-cols-6 w-100 min-h-screen h-auto">
            <nav className="bg-dark-purple lg:col-span-1 h-100 flex flex-col justify-between">
                <div className="flex flex-col p-4">
                    <a href='/' className="flex flex-row items-center gap-8 mb-8 font-bold ml-3">
                    <KerjaWoiIcon />
                    <h4 className="text-white text-xl">KerjaWOI</h4>
                    </a>
                    <div className="flex flex-col gap-4">
                    <a href='/' className="flex flex-row items-center gap-6 cursor-pointer bg-dark-blue bg-opacity-0 hover:bg-opacity-100 transition-all p-4 rounded-md">
                        <DashboardIcon />
