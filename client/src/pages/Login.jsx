...
const Login = () => {
    return (
        ...
        h-full bg-dark-purple ">
            ...
            w-[35%] min-w-[400px] h-3/5 bg-white px-8 text-dark-purple">
                ...
                <div className="forgot-container flex w-full justify-end mb-8">
                    <button className="hover:text-dark-blue hover:underline">Forgot Password?</button>
                </div>
                ...
                <div className="signup flex w-full justify-start">
                    <p>Don't have an account? <button className="font-medium hover:text-dark-blue hover:underline">Sign up now!</button></p>
                </div>
