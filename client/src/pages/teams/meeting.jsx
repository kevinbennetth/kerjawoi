...
const projects = [
    {name:"PapiKatering", desc:"Papi Katering is a Food Catering Web Application that is developed using MERN Stack"},
    {name:"Shoplexify", desc:"A Multi-page Online Shop Web Application that is developed using Flask as Backend and Bootstrap as Frontend"},
...
const Meeting = () => {
    ...
    return (
        <DashboardLayout>
            ...
            {allProjects.slice((current-1)*6, current*6).map((project, key)=><MeetingCard key={key}/>)}
            </div>
