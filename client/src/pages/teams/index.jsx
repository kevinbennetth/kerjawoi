...
const teams = [
  {name:"Do Stuff", lead:"Mr. Nobody", last_update:"25th May 2022", people:[
  ...
  {name:"Apple", lead:"Mrs. Appleman", last_update:"23rd June 2022", people:[
    'https://randomuser.me/api/portraits/women/46.jpg', 
    'https://randomuser.me/api/portraits/women/6.jpg', 
...
const Teams = ()=>{
  ...
  useEffect(()=>{
    let res = [...teams, ...teams, ...teams, ...teams, ...teams,...teams, ...teams, ...teams, ...teams, ...teams, ...teams ];
    setAllTeams(res);
    if(res.length%6===0){
